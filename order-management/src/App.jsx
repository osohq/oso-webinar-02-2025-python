    ...
    <div className="container">
      <div className="header">
        ...
        {currentUser &&
          ...
          currentUser.orgPermissions.includes("create_order") && (
            <button
              ...
              <tr key={order.id} className="table-row">
                ...
                <td className="table-cell">
                  <div className="action-buttons">
                    {(order.permissions.includes("fulfill_order") ||
                      order.permissions.includes("*")) &&
                    ...
                    {(order.permissions.includes("cancel_order") ||
                      order.permissions.includes("*")) &&
                      order.status === "pending" && (
                        <button
                    ...
                    {(order.permissions.includes("delete_order") ||
                      order.permissions.includes("*")) &&
