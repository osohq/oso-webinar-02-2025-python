...
def list_orders():
    ...
    for order in orders.values():
        # Skip orders from other organizations. You'll now see that
        ...
        # We can prevent the button for canceling an order from even
        # displaying.
        order_permissions = []
...
def cancel_order(order_id: str):
    ...
    # Sales members cannot cancel other sales members' orders.
